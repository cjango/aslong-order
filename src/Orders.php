...
use AsLong\Order\Contracts\Addressbook;
use AsLong\Order\Contracts\Orderable;
use AsLong\Order\Events\OrderCreated;
use AsLong\Order\Exceptions\OrderException;
use AsLong\Order\Models\Order;
use AsLong\Order\Models\OrderDetail;
use AsLong\Order\Models\OrderExpress;
...
class Orders
{
     ...
     * @param $items   商品详情
     * array[
     *     new OrderDetail(['goods' => AsLong\Order\Contracts\Orderable, 'number' => int]),
     *     new OrderDetail(['goods' => AsLong\Order\Contracts\Orderable, 'number' => int]),
     * ]
